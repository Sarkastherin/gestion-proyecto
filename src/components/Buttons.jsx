...
export const Button = React.forwardRef(
  (
    ...
    const baseClasses = `inline-flex items-center justify-center gap-1 rounded-${rounded} border ${
      hidden_text ? "p-2.5" : "px-7 py-2.5 disabled:border-neutral-400 disabled:bg-neutral-400 disabled:hover:border-neutral-400 disabled:hover:bg-neutral-400 disabled:hover:text-white disabled:text-white disabled:cursor-not-allowed"
