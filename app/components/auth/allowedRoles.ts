...
export const ALLOWED_REPORTS_EMPLOYEES: Roles[] = ["administrador", "dueño", "gabrilm", "coordinador"];
...
export const ALLOWED_RRHH: Roles[] = ["administrador", "dueño", "gabrilm", "coordinador"];
