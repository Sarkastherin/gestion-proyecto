...
export const ALLOWED_NEW_OPPORTUNITY: Roles[] = ["administrador", "dueño"];
export const ALLOWED_OPPORTUNITIES: Roles[] = ["administrador", "dueño", "coordinador"];
export const ALLOWED_REPORTS_EMPLOYEES: Roles[] = ["administrador"];
export const ALLOWED_SETTINGS: Roles[] = ["administrador", "dueño", "coordinador"];
export const ALLOWED_PROJECTS: Roles[] = ["administrador", "dueño"];
