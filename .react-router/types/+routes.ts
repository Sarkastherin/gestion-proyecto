...
type RouteFiles = {
  ...
  "layouts/project.tsx": {
    id: "layouts/project";
    page: "/project/:id/resumen" | "/project/:id/information" | "/project/:id/budget/items" | "/project/:id/budget/materials";
  };
